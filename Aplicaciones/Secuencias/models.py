...
class Lavado_buzo(models.Model):
    ...
    sistema=models.ForeignKey(to=Sistema, on_delete=models.CASCADE, verbose_name="Sistema", null=True, blank=False)
    fecha_lavado_buzo=models.DateField(verbose_name="Fecha de lavado de buzos", null=True, blank=True, default=progrmado)
    fecha_lavado_celda=models.DateField(verbose_name="Fecha de lavado de celda", null=True, blank=True, default=progrmado)
    fecha_test_diagnostico=models.DateField(verbose_name="Fecha del test", null=True, blank=True, default=progrmado)
    fecha_mantenimiento=models.DateField(verbose_name="Fecha del Mantenimiento", null=True, blank=True, default=progrmado_mantenimiento) 
    fecha_calificacion=models.DateField(verbose_name="Fecha de la calificación", null=True, blank=True, default=progrmado_mantenimiento) 
    fecha_alerta_inferior=models.DateField(verbose_name="Fecha de alerta inferior", null=True, blank=True, default=limite_inferior)
    fecha_alerta_superior=models.DateField(verbose_name="Fecha de alerta superior", null=True, blank=True, default=limite_superior)
    fecha_alerta_inferior_celda=models.DateField(verbose_name="Fecha de alerta inferior celda", null=True, blank=True, default=limite_inferior)
    fecha_alerta_superior_celda=models.DateField(verbose_name="Fecha de alerta superior celda", null=True, blank=True, default=limite_superior)
    fecha_alerta_inferior_test=models.DateField(verbose_name="Fecha de alerta inferior test", null=True, blank=True, default=limite_inferior)
    fecha_alerta_superior_test=models.DateField(verbose_name="Fecha de alerta superior test", null=True, blank=True, default=limite_superior) 
    fecha_alerta_inferior_mantenimiento=models.DateField(verbose_name="Fecha de alerta inferior mantenimiento", null=True, blank=True, default=limite_inferior_mantenimiento) 
    fecha_alerta_superior_mantenimiento=models.DateField(verbose_name="Fecha de alerta superior mantenimiento", null=True, blank=True, default=limite_superior_mantenimiento) 
    fecha_alerta_inferior_calificacion=models.DateField(verbose_name="Fecha de alerta inferior calificación", null=True, blank=True, default=limite_inferior_mantenimiento) 
    fecha_alerta_superior_calificacion=models.DateField(verbose_name="Fecha de alerta superior calificación", null=True, blank=True, default=limite_superior_mantenimiento) 
