...
from Aplicaciones.Protocolo_Metodos.models import Ensayo, Celda, Cliente, Muestras_y_Placebos
import datetime


# Create your models here.

class Estado_Proceso(models.Model):
...
class Proceso(models.Model):
     ...
     estado_del_proceso=models.ForeignKey(to=Estado_Proceso, on_delete=models.CASCADE, verbose_name="Estado del proceso", null=True, blank=False)
     class Condicion(models.TextChoices):
        ACTIVO = "Activo", "ACTIVO"
        PASIVO = "Pasivo", "PASIVO"
     condicion=models.CharField(max_length=90, choices=Condicion.choices, default=Condicion.ACTIVO, verbose_name="Condicion")  
