...
class Parametro(models.Model):
    ...
    #nombre_parametro=models.ForeignKey(Subparametro, on_delete=models.CASCADE, verbose_name="Nombre Parametro", null=True, blank=True, unique=True)
    ...
    #status_parametro=models.CharField(max_length=90, choices=Progreso.choices, default=Progreso.INGRESADO, verbose_name="Progreso")
    class Condicion(models.TextChoices):
        ACTIVO = "Activo", "ACTIVO"
        PASIVO = "Pasivo", "PASIVO"
    condicion=models.CharField(max_length=90, choices=Condicion.choices, default=Condicion.ACTIVO, verbose_name="Condicion")  
    ...
    # <QuerySet [{'id': 1, 'nombre_subparametro': 'Analista 1 dia 1'}]
